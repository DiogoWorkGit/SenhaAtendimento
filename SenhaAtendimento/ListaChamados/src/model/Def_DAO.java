...
import static view.Window_GUI.lbl_num1;
...
import static view.Window_GUI.lbl_NormPref1;
import static view.Window_GUI.lbl_NormPref2;
import static view.Window_GUI.lbl_num2;
import static view.Window_GUI.lbl_old5;
import static view.Window_GUI.lbl_old7;
import static view.Window_GUI.lbl_old8;
import static view.Window_GUI.lbl_old6;
...
public class Def_DAO {
    ...
    public static void Mostra(){
        lbl_num1.setText("A"+Integer.toString(model.Variables_DAO.numNormal[p]));
        ...
        lbl_NormPref1.setText("Convencional");
    ...
    public static void MostraPreferencial(){
        lbl_num2.setText("P"+Integer.toString(model.Variables_DAO.numPreferencial[p2]));
        lbl_old5.setText("P"+Integer.toString(model.Variables_DAO.numPreferencial[o2]));
        lbl_old6.setText("P"+Integer.toString(model.Variables_DAO.numPreferencial[n2]));
        lbl_old7.setText("P"+Integer.toString(model.Variables_DAO.numPreferencial[m2]));
        lbl_old8.setText("P"+Integer.toString(model.Variables_DAO.numPreferencial[l2]));
        lbl_NormPref2.setText("Preferencial");
